...
export default class AtCalendarBody extends Taro.Component {
  constructor(props) {
    ...
    const { marks, format, minDate, maxDate, generateDate, selectedDate, selectedDates } = props;
  ...
  componentWillReceiveProps(nextProps) {
    const { marks, format, minDate, maxDate, generateDate, selectedDate, selectedDates } = nextProps;
    this.generateFunc = generateCalendarGroup({
      format,
      minDate,
      maxDate,
